...
class AuthUser(models.Model):
    ...
    profession = models.ForeignKey('Professions', models.DO_NOTHING, blank=True, null=True)
    birthdate = models.DateField(blank=True, null=True)
    insurance = models.ForeignKey('Insurances', models.DO_NOTHING, blank=True, null=True)
...
class Institutions(models.Model):
    ...
    institution_user = models.ForeignKey(AuthUser, models.DO_NOTHING)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField(blank=True, null=True)
...
class Locks(models.Model):
    ...
    lock_user = models.ForeignKey(AuthUser, models.DO_NOTHING)
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField(blank=True, null=True)
